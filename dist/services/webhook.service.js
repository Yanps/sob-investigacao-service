 ...
 */
async function hasAccessToAgent(phoneNumber) {
...
const MESSAGE_NO_ACCESS = "Para falar com o delegado, você precisa ter um jogo ativo.\n\n" +
...
export async function handleWhatsappWebhook(payload) {
     ...
     * Condição comentada: todos os números seguem direto para o agente (sem exigir order/gift card).
     */
